...
- [x] Fix baseline, evidence boundary and preserved user change.
- [x] Trace canonical retained plan, cursor and candidate contracts.
- [x] Trace current problem/observation/stage-geometry provenance.
- [x] Trace solved-progress course-frame and swept wall certificate producers.
- [x] Trace current dynamic-obstacle prediction into stage lateral bounds.
- [x] Separate elapsed-time, absolute-progress and current-observation axes.

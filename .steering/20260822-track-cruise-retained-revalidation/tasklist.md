...
- [x] Freeze baseline, scope and preserved user change.
- [x] Reconfirm the retained proof gap in source.
- [x] Record root cause and selected typed-proof design.
- [x] Add failure-first tests for exact window, progress lift and proof identity.

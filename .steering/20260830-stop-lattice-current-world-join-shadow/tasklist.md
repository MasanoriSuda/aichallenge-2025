...
- [x] Freeze the first authority-loss evidence and hypotheses.
- [x] Add failure-first source/ownership tests.
- [x] Retain only the latest accepted Stop lattice plan for observation.
- [x] Evaluate it at ordinary ShiftOut/Pass authority loss.

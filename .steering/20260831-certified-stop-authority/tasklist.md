...
- [x] Freeze decision 1609 and run same-snapshot A/B/C/D.
- [x] Classify the forward state as physical no-escape with a certified Stop.
- [x] Trace Stop publication through retained, publisher and atomic ledgers.

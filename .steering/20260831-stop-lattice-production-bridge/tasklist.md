...
- [x] Freeze the dynamic root-cause evidence.
- [x] Add failure-first authority ordering and single-evaluation tests.
- [x] Replace the shadow observer with one typed alternate evaluation.
- [x] Select accepted lattice authority before external Stop.

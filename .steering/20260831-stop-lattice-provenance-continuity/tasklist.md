...
- [x] Freeze decision 2257--2261 evidence.
- [x] Trace the selected plan through final publication and invalidation.
- [x] Identify the missing exact Stop solver-source provenance.
- [x] Add a failure-first provenance test.

# Tasklist: Stop stationary trajectory contract

- [x] Freeze and classify decision 1116.
- [x] Add a regression test for zero speed reached inside one publisher interval.

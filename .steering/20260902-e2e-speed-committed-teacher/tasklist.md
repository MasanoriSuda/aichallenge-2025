...
- [x] Freeze production and historical teacher identities.
- [x] Reconstruct the seed 2032 crash at scan resolution.
- [x] Implement the distinct speed-aware committed teacher.
- [x] Thread fresh wheel speed through runtime without changing topics.

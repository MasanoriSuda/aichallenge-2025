...
for domain in (1, 2):
    ...
    while reader.has_next():
        ...
        if topic == selected[0]:
            ...
            if 85 <= seconds(msg.header.stamp) <= 95:
            ...
            for vehicle in msg.vehicles:
                if 85 <= seconds(vehicle.header.stamp) <= 95:
    ...
    result[f"d{domain}"] = {"control_stats": stats, "ego_85_95s": ego, "peers_85_95s": peers,
                            "control_85_95s": [c for c in controls if 85 <= c["source_sec"] <= 95]}

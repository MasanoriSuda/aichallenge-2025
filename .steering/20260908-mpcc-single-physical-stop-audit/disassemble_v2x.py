...
selected = {
    'GnssSensor': {'Start', 'FixedUpdate'},
    'MultiDomainV2XVehiclePositionFanout': {'Broadcast', 'FillArrayMsg'},
...
Path('output/20260908-mpcc-stop-reference-single-r3/unity-v2x-origin-cil.txt').write_text(
    '\n'.join(lines) + '\n')

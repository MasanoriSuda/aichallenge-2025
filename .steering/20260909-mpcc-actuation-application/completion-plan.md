...
後続の[具体化計画](../20260909-mpcc-longitudinal-model-contract/completion-plan.md)が現行。
下記はae2efe6a時点の計画を保持する。一定responseの全horizon拡張は後続native静止
反例で棄却し、接地・横運動と適用不確かさを含む因果的モデル比較へ進める。

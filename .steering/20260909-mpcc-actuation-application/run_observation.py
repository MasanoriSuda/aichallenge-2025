...
root = Path('output/20260909-actuation-observed-'+mode+'-'+attempt)
...
manifest = dict(run_id=root.name, kind='actuation-application-observation-'+mode,
...
manifest['scope'] = 'Receiver/selection/application trace in generated simulator DLL only. Controller unchanged at1c4f377e. Original branch and exception flow statically compared across3608methods after stripping4probe calls. Added logging affects runtime timing; diagnostic run, not race/performance acceptance.'

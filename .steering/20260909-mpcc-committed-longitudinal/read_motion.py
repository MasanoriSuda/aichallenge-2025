...
domain = sys.argv[4] if len(sys.argv) > 4 else '2'
uri = str(root / ('d'+domain) / 'rosbag2_autoware')
...
(root / ('d'+domain+'-longitudinal-full-motion.json')).write_text(json.dumps(result, indent=2) + '\n')

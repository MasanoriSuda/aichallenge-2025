...
out=Path('/output/20260909-exact-join-peer-timeline');out.mkdir(exist_ok=False)
...
for row in rows:
    if row['stamp']>=9.95:print(json.dumps(row),flush=True)

...
steering = Path('/task-steering/20260909-mpcc-failure-observation-bundle')
run = Path('/output/20260909-failure-bundle-dev2-r1')
out = Path('/output/20260909-failure-bundle-execution-replay')
...
command = [link[0], '-std=c++17','-O2','-I'+str(package/'include'),'-I'+str(package/'src'),'-I/usr/include/eigen3',
    str(steering/'replay_execution.cpp'),str(copy),'-o',str(out/'reconstruct_execution'),

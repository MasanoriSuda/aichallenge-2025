"""Unchanged bounded architecture comparisons on the immutable 928 world."""
from pathlib import Path
import hashlib,json,subprocess

out=Path('/output/20260909-force-step-928-comparison-r1');out.mkdir(exist_ok=False)
source=next(Path('/output/20260909-force-step-observed-dev2-r1/d1/mpcc_architecture_snapshots').glob('000000000928*normal-authority*/snapshot.yaml'))

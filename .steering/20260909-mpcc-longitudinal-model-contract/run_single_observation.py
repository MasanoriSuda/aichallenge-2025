...
root = Path('output/20260909-longitudinal-observed-'+mode+'-'+attempt)
...
manifest = dict(run_id=root.name, kind='longitudinal-model-input-observation-'+mode,
                ...
                termination='all vehicles finished, first active moving Emergency/Recovery, or840s host diagnostic deadline',
...
manifest['scope'] = 'Broad single six-lap direct application observation for acceleration/braking/rest/steering model comparison. Participant remains1c4f377e; no gain/model/limit/solver change. Same four validated receiver probes asae2efe6a. Observation-only, not uninstrumented race/performance acceptance.'
...
summary = {}
termination = '840s host diagnostic deadline'
try:

...
out=Path('/output/20260909-measured-heading-933-comparison-r1');out.mkdir(exist_ok=False)
source=next(Path('/output/20260909-measured-heading-dev2-r1/d1/mpcc_architecture_snapshots').glob('000000000933*normal-authority*/snapshot.yaml'))

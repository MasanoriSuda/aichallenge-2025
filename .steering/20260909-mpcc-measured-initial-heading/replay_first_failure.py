...
run = Path('/output/20260909-measured-heading-dev2-r1')
assert (run/'monitor-summary.json').exists(), 'Simulator must finish first'
out = Path('/output/20260909-measured-heading-revalidation-r1')
...
records = []
for domain in ['d1']:
    for path in sorted((run/domain/'mpcc_architecture_snapshots').glob('000000000933*/snapshot.yaml')):

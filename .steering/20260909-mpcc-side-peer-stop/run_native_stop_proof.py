"""Bind exact QP proof to the native full-horizon Stop certificate contract."""
...
out=Path('/output/20260909-side-peer-stop-audit/native-stop-proof-r2')
...
command=[link[0],'-std=c++17','-O2','-I'+str(package/'include'),'-I'+str(package/'src'),'-I/usr/include/eigen3',
         str(steering/'world_probe.cpp'),'-o',str(out/'probe'),

...
out=Path('/output/20260909-stop-provenance-missions');out.mkdir(exist_ok=False)
...
results=[]
for run,domain,decision in [('20260909-complete-rest-dev2-r1','d2',923),('20260909-failure-bundle-dev2-r1','d2',1629),('20260909-complete-stop-dev2-r1','d1',4264)]:

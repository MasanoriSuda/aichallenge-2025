...
test_log = Path('/tmp/mpcc-nine-state-tests-r62.log')
build_log = Path('/tmp/mpcc-nine-state-build-r74.log')
assert 'Summary: 2494 tests, 0 errors, 0 failures, 0 skipped' in test_log.read_text()

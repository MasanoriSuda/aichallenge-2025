...
test_log = Path('/tmp/mpcc-nine-state-tests-r87.log')
build_log = Path('/tmp/mpcc-nine-state-build-r100.log')
assert 'Summary: 2574 tests, 0 errors, 0 failures, 0 skipped' in test_log.read_text()

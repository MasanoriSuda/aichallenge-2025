...
test_log = Path('/tmp/mpcc-nine-state-tests-r74.log')
build_log = Path('/tmp/mpcc-nine-state-build-r86.log')
assert 'Summary: 2530 tests, 0 errors, 0 failures, 0 skipped' in test_log.read_text()

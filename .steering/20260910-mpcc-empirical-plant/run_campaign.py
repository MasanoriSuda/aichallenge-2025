...
test_log = Path('/tmp/mpcc-nine-state-tests-r6.log')
build_log = Path('/tmp/mpcc-nine-state-build-r8.log')
assert 'Summary: 2387 tests, 0 errors, 0 failures, 0 skipped' in test_log.read_text()

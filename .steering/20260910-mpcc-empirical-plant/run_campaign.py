...
test_log = Path('/tmp/mpcc-nine-state-tests-r11.log')
build_log = Path('/tmp/mpcc-nine-state-build-r15.log')
assert 'Summary: 2393 tests, 0 errors, 0 failures, 0 skipped' in test_log.read_text()

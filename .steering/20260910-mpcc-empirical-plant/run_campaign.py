...
test_log = Path('/tmp/mpcc-nine-state-tests-r76.log')
build_log = Path('/tmp/mpcc-nine-state-build-r88.log')
assert 'Summary: 2532 tests, 0 errors, 0 failures, 0 skipped' in test_log.read_text()

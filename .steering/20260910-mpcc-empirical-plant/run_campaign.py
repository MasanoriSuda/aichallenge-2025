...
test_log = Path('/tmp/mpcc-nine-state-tests-r37.log')
build_log = Path('/tmp/mpcc-nine-state-build-r44.log')
assert 'Summary: 2433 tests, 0 errors, 0 failures, 0 skipped' in test_log.read_text()

...
test_log = Path('/tmp/mpcc-nine-state-tests-r83.log')
build_log = Path('/tmp/mpcc-nine-state-build-r95.log')
assert 'Summary: 2561 tests, 0 errors, 0 failures, 0 skipped' in test_log.read_text()

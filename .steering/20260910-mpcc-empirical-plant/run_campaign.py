...
test_log = Path('/tmp/mpcc-nine-state-tests-r103.log')
build_log = Path('/tmp/mpcc-nine-state-build-r116.log')
assert 'Summary: 2598 tests, 0 errors, 0 failures, 0 skipped' in test_log.read_text()

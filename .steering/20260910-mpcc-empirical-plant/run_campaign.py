...
test_log = Path('/tmp/mpcc-nine-state-tests-r89.log')
build_log = Path('/tmp/mpcc-nine-state-build-r102.log')
assert 'Summary: 2579 tests, 0 errors, 0 failures, 0 skipped' in test_log.read_text()

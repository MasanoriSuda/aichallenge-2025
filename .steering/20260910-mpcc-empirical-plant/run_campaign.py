...
test_log = Path('/tmp/mpcc-nine-state-tests-r85.log')
build_log = Path('/tmp/mpcc-nine-state-build-r97.log')
assert 'Summary: 2565 tests, 0 errors, 0 failures, 0 skipped' in test_log.read_text()

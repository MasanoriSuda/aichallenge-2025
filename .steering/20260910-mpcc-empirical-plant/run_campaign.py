...
test_log = Path('/tmp/mpcc-nine-state-tests-r35.log')
build_log = Path('/tmp/mpcc-nine-state-build-r42.log')
assert 'Summary: 2430 tests, 0 errors, 0 failures, 0 skipped' in test_log.read_text()

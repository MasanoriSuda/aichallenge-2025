...
test_log = Path('/tmp/mpcc-nine-state-tests-r58.log')
build_log = Path('/tmp/mpcc-nine-state-build-r70.log')
assert 'Summary: 2480 tests, 0 errors, 0 failures, 0 skipped' in test_log.read_text()

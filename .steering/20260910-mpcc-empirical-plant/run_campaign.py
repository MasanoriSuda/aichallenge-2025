...
test_log = Path('/tmp/mpcc-nine-state-tests-r82.log')
build_log = Path('/tmp/mpcc-nine-state-build-r94.log')
assert 'Summary: 2560 tests, 0 errors, 0 failures, 0 skipped' in test_log.read_text()

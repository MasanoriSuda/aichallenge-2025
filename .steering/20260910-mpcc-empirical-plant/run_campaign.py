...
test_log = Path('/tmp/mpcc-nine-state-tests-r51.log')
build_log = Path('/tmp/mpcc-nine-state-build-r62.log')
assert 'Summary: 2462 tests, 0 errors, 0 failures, 0 skipped' in test_log.read_text()

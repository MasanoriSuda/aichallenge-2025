...
test_log = Path('/tmp/mpcc-nine-state-tests-r52.log')
build_log = Path('/tmp/mpcc-nine-state-build-r63.log')
assert 'Summary: 2464 tests, 0 errors, 0 failures, 0 skipped' in test_log.read_text()

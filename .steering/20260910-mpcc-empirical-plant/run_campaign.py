...
test_log = Path('/tmp/mpcc-nine-state-tests-r32.log')
build_log = Path('/tmp/mpcc-nine-state-build-r40.log')
assert 'Summary: 2427 tests, 0 errors, 0 failures, 0 skipped' in test_log.read_text()

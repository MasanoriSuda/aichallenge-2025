...
test_log = Path('/tmp/mpcc-nine-state-tests-r36.log')
build_log = Path('/tmp/mpcc-nine-state-build-r43.log')
assert 'Summary: 2432 tests, 0 errors, 0 failures, 0 skipped' in test_log.read_text()

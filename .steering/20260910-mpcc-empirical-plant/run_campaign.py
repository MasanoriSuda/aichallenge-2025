...
test_log = Path('/tmp/mpcc-nine-state-tests-r105.log')
build_log = Path('/tmp/mpcc-nine-state-build-r118.log')
assert 'Summary: 2600 tests, 0 errors, 0 failures, 0 skipped' in test_log.read_text()

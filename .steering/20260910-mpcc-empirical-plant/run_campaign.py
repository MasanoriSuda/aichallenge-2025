...
test_log = Path('/tmp/mpcc-nine-state-tests-r79.log')
build_log = Path('/tmp/mpcc-nine-state-build-r91.log')
assert 'Summary: 2545 tests, 0 errors, 0 failures, 0 skipped' in test_log.read_text()

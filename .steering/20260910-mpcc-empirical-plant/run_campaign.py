...
test_log = Path('/tmp/mpcc-nine-state-tests-r54.log')
build_log = Path('/tmp/mpcc-nine-state-build-r65.log')
assert 'Summary: 2466 tests, 0 errors, 0 failures, 0 skipped' in test_log.read_text()

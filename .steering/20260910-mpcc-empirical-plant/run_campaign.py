...
test_log = Path('/tmp/mpcc-nine-state-tests-r84.log')
build_log = Path('/tmp/mpcc-nine-state-build-r96.log')
assert 'Summary: 2564 tests, 0 errors, 0 failures, 0 skipped' in test_log.read_text()

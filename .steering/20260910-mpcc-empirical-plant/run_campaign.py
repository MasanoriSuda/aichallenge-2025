...
test_log = Path('/tmp/mpcc-nine-state-tests-r43.log')
build_log = Path('/tmp/mpcc-nine-state-build-r53.log')
assert 'Summary: 2449 tests, 0 errors, 0 failures, 0 skipped' in test_log.read_text()

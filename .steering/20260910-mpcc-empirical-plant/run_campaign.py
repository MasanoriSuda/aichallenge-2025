...
test_log = Path('/tmp/mpcc-nine-state-tests-r17.log')
build_log = Path('/tmp/mpcc-nine-state-build-r21.log')
assert 'Summary: 2401 tests, 0 errors, 0 failures, 0 skipped' in test_log.read_text()

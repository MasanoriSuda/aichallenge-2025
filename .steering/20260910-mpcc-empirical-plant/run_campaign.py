...
test_log = Path('/tmp/mpcc-nine-state-tests-r42.log')
build_log = Path('/tmp/mpcc-nine-state-build-r52.log')
assert 'Summary: 2447 tests, 0 errors, 0 failures, 0 skipped' in test_log.read_text()

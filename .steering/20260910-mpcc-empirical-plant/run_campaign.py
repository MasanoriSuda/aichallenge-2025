...
test_log = Path('/tmp/mpcc-nine-state-tests-r41.log')
build_log = Path('/tmp/mpcc-nine-state-build-r51.log')
assert 'Summary: 2441 tests, 0 errors, 0 failures, 0 skipped' in test_log.read_text()

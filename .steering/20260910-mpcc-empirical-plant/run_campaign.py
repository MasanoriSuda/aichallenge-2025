...
test_log = Path('/tmp/mpcc-nine-state-tests-r7.log')
build_log = Path('/tmp/mpcc-nine-state-build-r9.log')
assert 'Summary: 2388 tests, 0 errors, 0 failures, 0 skipped' in test_log.read_text()

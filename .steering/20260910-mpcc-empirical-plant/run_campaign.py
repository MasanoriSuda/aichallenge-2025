...
test_log = Path('/tmp/mpcc-nine-state-tests-r53.log')
build_log = Path('/tmp/mpcc-nine-state-build-r64.log')
assert 'Summary: 2465 tests, 0 errors, 0 failures, 0 skipped' in test_log.read_text()

...
test_log = Path('/tmp/mpcc-nine-state-tests-r104.log')
build_log = Path('/tmp/mpcc-nine-state-build-r117.log')
assert 'Summary: 2599 tests, 0 errors, 0 failures, 0 skipped' in test_log.read_text()

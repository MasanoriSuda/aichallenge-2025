...
test_log = Path('/tmp/mpcc-nine-state-tests-r64.log')
build_log = Path('/tmp/mpcc-nine-state-build-r75.log')
assert 'Summary: 2505 tests, 0 errors, 0 failures, 0 skipped' in test_log.read_text()

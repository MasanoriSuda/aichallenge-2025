...
test_log = Path('/tmp/mpcc-nine-state-tests-r57.log')
build_log = Path('/tmp/mpcc-nine-state-build-r68.log')
assert 'Summary: 2471 tests, 0 errors, 0 failures, 0 skipped' in test_log.read_text()

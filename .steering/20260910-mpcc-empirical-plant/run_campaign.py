...
test_log = Path('/tmp/mpcc-nine-state-tests-r107.log')
build_log = Path('/tmp/mpcc-nine-state-build-r120.log')
assert 'Summary: 2610 tests, 0 errors, 0 failures, 0 skipped' in test_log.read_text()

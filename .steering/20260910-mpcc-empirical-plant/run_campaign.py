...
test_log = Path('/tmp/mpcc-nine-state-tests-r59.log')
build_log = Path('/tmp/mpcc-nine-state-build-r71.log')
assert 'Summary: 2483 tests, 0 errors, 0 failures, 0 skipped' in test_log.read_text()

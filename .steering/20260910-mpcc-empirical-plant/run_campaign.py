...
test_log = Path('/tmp/mpcc-nine-state-tests-r18.log')
build_log = Path('/tmp/mpcc-nine-state-build-r24.log')
assert 'Summary: 2402 tests, 0 errors, 0 failures, 0 skipped' in test_log.read_text()

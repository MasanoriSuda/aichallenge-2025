...
test_log = Path('/tmp/mpcc-nine-state-tests-r92.log')
build_log = Path('/tmp/mpcc-nine-state-build-r105.log')
assert 'Summary: 2583 tests, 0 errors, 0 failures, 0 skipped' in test_log.read_text()

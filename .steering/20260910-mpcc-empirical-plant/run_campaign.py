...
test_log = Path('/tmp/mpcc-nine-state-tests-r15.log')
build_log = Path('/tmp/mpcc-nine-state-build-r19.log')
assert 'Summary: 2397 tests, 0 errors, 0 failures, 0 skipped' in test_log.read_text()

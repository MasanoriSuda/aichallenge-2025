...
test_log = Path('/tmp/mpcc-nine-state-tests-r98.log')
build_log = Path('/tmp/mpcc-nine-state-build-r112.log')
assert 'Summary: 2589 tests, 0 errors, 0 failures, 0 skipped' in test_log.read_text()

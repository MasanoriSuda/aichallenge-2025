...
test_log = Path('/tmp/mpcc-nine-state-tests-r86.log')
build_log = Path('/tmp/mpcc-nine-state-build-r99.log')
assert 'Summary: 2570 tests, 0 errors, 0 failures, 0 skipped' in test_log.read_text()

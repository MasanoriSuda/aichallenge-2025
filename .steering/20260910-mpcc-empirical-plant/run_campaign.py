...
test_log = Path('/tmp/mpcc-nine-state-tests-r102.log')
build_log = Path('/tmp/mpcc-nine-state-build-r115.log')
assert 'Summary: 2596 tests, 0 errors, 0 failures, 0 skipped' in test_log.read_text()

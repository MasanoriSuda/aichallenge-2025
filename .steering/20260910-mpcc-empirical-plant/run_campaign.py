...
test_log = Path('/tmp/mpcc-nine-state-tests-r97.log')
build_log = Path('/tmp/mpcc-nine-state-build-r111.log')
assert 'Summary: 2587 tests, 0 errors, 0 failures, 0 skipped' in test_log.read_text()

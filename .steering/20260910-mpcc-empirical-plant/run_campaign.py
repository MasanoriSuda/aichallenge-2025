...
test_log = Path('/tmp/mpcc-nine-state-tests-r39.log')
build_log = Path('/tmp/mpcc-nine-state-build-r47.log')
assert 'Summary: 2437 tests, 0 errors, 0 failures, 0 skipped' in test_log.read_text()

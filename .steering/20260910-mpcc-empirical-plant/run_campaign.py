...
test_log = Path('/tmp/mpcc-nine-state-tests-r65.log')
build_log = Path('/tmp/mpcc-nine-state-build-r76.log')
assert 'Summary: 2509 tests, 0 errors, 0 failures, 0 skipped' in test_log.read_text()

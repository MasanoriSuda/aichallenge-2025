...
test_log = Path('/tmp/mpcc-nine-state-tests-r93.log')
build_log = Path('/tmp/mpcc-nine-state-build-r107.log')
assert 'Summary: 2584 tests, 0 errors, 0 failures, 0 skipped' in test_log.read_text()

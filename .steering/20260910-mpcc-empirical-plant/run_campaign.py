...
test_log = Path('/tmp/mpcc-nine-state-tests-r26.log')
build_log = Path('/tmp/mpcc-nine-state-build-r31.log')
assert 'Summary: 2409 tests, 0 errors, 0 failures, 0 skipped' in test_log.read_text()

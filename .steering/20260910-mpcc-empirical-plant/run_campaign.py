...
test_log = Path('/tmp/mpcc-nine-state-tests-r38.log')
build_log = Path('/tmp/mpcc-nine-state-build-r45.log')
assert 'Summary: 2434 tests, 0 errors, 0 failures, 0 skipped' in test_log.read_text()

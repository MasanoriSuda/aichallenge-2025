...
test_log = Path('/tmp/mpcc-nine-state-tests-r106.log')
build_log = Path('/tmp/mpcc-nine-state-build-r119.log')
assert 'Summary: 2602 tests, 0 errors, 0 failures, 0 skipped' in test_log.read_text()

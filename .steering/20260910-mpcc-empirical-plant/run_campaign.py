...
test_log = Path('/tmp/mpcc-nine-state-tests-r24.log')
build_log = Path('/tmp/mpcc-nine-state-build-r29.log')
assert 'Summary: 2407 tests, 0 errors, 0 failures, 0 skipped' in test_log.read_text()

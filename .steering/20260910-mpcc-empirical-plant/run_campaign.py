...
test_log = Path('/tmp/mpcc-nine-state-tests-r101.log')
build_log = Path('/tmp/mpcc-nine-state-build-r114.log')
assert 'Summary: 2592 tests, 0 errors, 0 failures, 0 skipped' in test_log.read_text()

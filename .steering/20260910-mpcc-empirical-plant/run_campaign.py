...
test_log = Path('/tmp/mpcc-nine-state-tests-r91.log')
build_log = Path('/tmp/mpcc-nine-state-build-r104.log')
assert 'Summary: 2582 tests, 0 errors, 0 failures, 0 skipped' in test_log.read_text()

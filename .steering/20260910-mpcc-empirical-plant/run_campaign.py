...
test_log = Path('/tmp/mpcc-nine-state-tests-r80.log')
build_log = Path('/tmp/mpcc-nine-state-build-r92.log')
assert 'Summary: 2547 tests, 0 errors, 0 failures, 0 skipped' in test_log.read_text()

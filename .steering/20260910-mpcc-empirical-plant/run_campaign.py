...
test_log = Path('/tmp/mpcc-nine-state-tests-r81.log')
build_log = Path('/tmp/mpcc-nine-state-build-r93.log')
assert 'Summary: 2554 tests, 0 errors, 0 failures, 0 skipped' in test_log.read_text()

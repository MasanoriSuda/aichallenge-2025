...
test_log = Path('/tmp/mpcc-nine-state-tests-r44.log')
build_log = Path('/tmp/mpcc-nine-state-build-r54.log')
assert 'Summary: 2451 tests, 0 errors, 0 failures, 0 skipped' in test_log.read_text()

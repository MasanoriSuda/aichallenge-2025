...
TEST(CanonicalNormalAsyncOvertakePreentry, RejectsMissingArtifact)
{
...
TEST(CanonicalNormalAsyncOvertakePreentry, AcceptsExactLiveIdentity)
{
  auto canonical_plan = std::make_shared<const plan::CanonicalExecutionPlan>(
...
TEST(CanonicalNormalAsyncOvertakePreentry, RejectsCrossPhaseArtifact)
{
  auto canonical_plan = std::make_shared<const plan::CanonicalExecutionPlan>(
    make_follow_plan(42U, 3U, 7U, contract::ControlIntent::Pass));
  const auto result = async::resolve_overtake_preentry_plan(
    async::OvertakePreentryPlanRequest{
...
TEST(CanonicalNormalAsyncOvertakePreentry, RejectsWrongMissionGeneration)
{
  auto canonical_plan = std::make_shared<const plan::CanonicalExecutionPlan>(
    make_follow_plan(42U, 2U, 7U, contract::ControlIntent::ShiftOut));
  const auto result = async::resolve_overtake_preentry_plan(
    async::OvertakePreentryPlanRequest{
      canonical_plan, contract::ControlIntent::ShiftOut, 3U, 7U, "d2", 1,
      10.1});
  ...
  EXPECT_EQ(
    result.reason,
    async::OvertakePreentryPlanReason::IntentGenerationMismatch);
}

TEST(CanonicalNormalAsyncOvertakePreentry, RejectsWrongSide)
{
  auto canonical_plan = std::make_shared<const plan::CanonicalExecutionPlan>(
    make_follow_plan(42U, 3U, 7U, contract::ControlIntent::ShiftOut));
  const auto result = async::resolve_overtake_preentry_plan(
  ...
  EXPECT_EQ(
    result.reason,
    async::OvertakePreentryPlanReason::ExecutionSideMismatch);
}

TEST(CanonicalNormalAsyncOvertakePreentry, RejectsExpiredArtifact)
{
  auto canonical_plan = std::make_shared<const plan::CanonicalExecutionPlan>(
    make_follow_plan(42U, 3U, 7U, contract::ControlIntent::ShiftOut));
  const auto result = async::resolve_overtake_preentry_plan(
